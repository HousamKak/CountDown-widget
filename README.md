...
You can find the `.exe` file in the `dist` directory, or download the widget directly from [here](https://github.com/HousamKak/CountDown-widget/blob/main/dist/my_countdown.exe).
